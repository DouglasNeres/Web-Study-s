                      ...
                      <form action="" method="post" class="contact-form" data-aos="fade-up" data-aos-delay="300" role="form">
                        <div class="row">
                          <div class="col-lg-6 col-12">
                            <input type="text" class="form-control" name="nome" placeholder="Name" value="<?php echo $nome;?>"> 
                          </div>
                          ...
                          <input type="date" class="form-control" name="datinha" value="<?php echo $datas;?>">
                          </div>
                          <!-- <div class="col-lg-12 col-12">
                           ...
                           <div class="col-lg-5 mx-auto col-7">
                            <button type="submit" class="form-control" id="submit-button" name="editar">Cadastrar-se</button>
                          </div>
                        </div>
